export default function Form (props){
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <label>Phone:
                <input onChange={handleChange} name='phone' type='tel' value={phone}/>
            </label>

            <label>State:
                <input onChange={handleChange} name='state' type='text' value={state}/>
            </label>

            <label>City:
                <input onChange={handleChange} name='city' type='text' value={city}/>
            </label>

            <label>Country:
                <input onChange={handleChange} name='country' type='text' value={country}/>
            </label>

            { isCareers ? (
                <label>Skill:
                    <select onChange={handleChange} name='skill' type='text' value={skill}>
            ...
            { isCareers ? (
                <label>Degree:
                    <select onChange={handleChange} name='degree' type='text' value={degree}>
            ...
            { isCareers ? (
                <label>Experience:
                    <select onChange={handleChange} name='experience' type='text' value={experience} >
            ...
            { isContact ? (
                <label>Contact:
                    <input onChange={handleChange} name='contact' type='text' value={contact}/>
                </label>
            ) : null }
